# Netflix Movies and TV Shows Data Analysis Using SQL(MYSQL)

![Netflix Logo](https://github.com/VinsonYuxuanLiang/Netflix_SQL_Project_MYSQL/blob/main/BrandAssets_Logos_01-Wordmark.jpg)
